    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        if (userData.role !== "teacher") {
          ...
          setLoading(false);
          return showToast(
            "Access Denied: This is not a Teacher account.",
            "error",
          );
        }
        ...
        if (userData.verified !== true) {
          await signOut(auth);
          setLoading(false);
          return showToast("Account pending Admin approval.", "warning");
        }
  ...
  return (
    <SafeAreaView style={{ backgroundColor: theme.bgPrimary, flex: 1 }}>
      ...
      <View className="px-4 py-2 flex-row items-center justify-between">
        ...
        <TouchableOpacity onPress={() => router.push("/(auth)/teachersignup")}>
          <Text style={{ color: theme.accent }} className="text-base font-bold">
            Sign Up
          </Text>
        </TouchableOpacity>
      </View>
